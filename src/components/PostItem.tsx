...
const PostItem: Component<PostItemProps> = (props: PostItemProps) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Profile Picture */}
        <Show when={!props.isSamePoster && !configs().compactMode}>
          <a class="mr-3 block aspect-square w-10 overflow-hidden rounded-full">
        ...
        >
          ...
          <div
            classList={{
              ...
              "pl-[3.25rem]": props.isSamePoster && !configs().compactMode,
            }}
          >
    ...
    <div
      classList={{
        ...
        "border-t dark:border-neutral-800":
          !isSamePoster && configs().lineSeparator,
      }}
      children={children}
    />
  );
