...
import { AiOutlineEllipsis, AiOutlineFileText, FaSolidPencil, FiTrash2, IoMailUnreadOutline } from "./svg.jsx";
...
const PostDropdown: Component<{
  ...
  return (
    <div class="dropdown min-w-fit pl-2">
      <button type="button" class={`btn ${!isTouchDevice ? "opacity-0 trigger" : ""}`}>
