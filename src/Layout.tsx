...
const Layout: Component = () => {
  return (
    <Sidebar
      ...
      class="flex h-full w-full flex-col items-center p-4 md:min-h-0"
    >
      <div class="layout-w flex flex-col items-center bg-white dark:bg-zinc-900">
        <Header />
        <Login />
      </div>
      <div class="layout-w my-4 flex min-h-0 flex-1 justify-center overflow-auto">
        <PostFeed />
      </div>
      <Show when={isLoggedIn()}>
        <div class="layout-w flex justify-center bg-white dark:bg-zinc-900">
          <PostComposer />
        </div>
      </Show>
    </Sidebar>
