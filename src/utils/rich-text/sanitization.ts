import type { RichText } from "./lib.js";
...
export function sanitizeRichText(richText: RichText, opts: { cleanNewlines?: boolean }) {
...
function clean(richText: RichText, targetRegexp: RegExp, replacementString: string): RichText {
